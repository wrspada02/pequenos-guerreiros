  ...
  return (
    <>
      ...
      <main className='overflow-hidden'>
        <section className='bg-gradient-primary mobile:pt-40 tablet:pt-40 desktop:pt-44 fullscreen:pt-60 mobile:pb-20 desktop:pb-20 mobile:px-16 tablet:px-24 desktop:px-32 fullscreen:px-40 animate-opacity-from-right min-h-screen section-std'>
        ...
        <section className='grid desktop:grid-cols-3 fullscreen:grid-cols-3 mobile:grid-cols-1 tablet:grid-cols-2 mobile:grid-rows-[0.5fr 1fr 0.5fr 1fr] tablet:grid-rows-[0.5fr 1fr 0.5fr 1fr] mobile:gap-y-10 tablet:gap-y-10 gap-x-5 p-10 section-std'>
        ...
        <section className='p-10 bg-green-default section-std'>
        ...
        <section className='p-10 after:z-20 before:z-20 after:content-[url("/commas-close.svg")] after:block before:content-[url("/commas-open.svg")]  before:block before:relative before:top-28 before:right-3 after:relative after:-top-5 after:right-0 after:float-right section-std'>
        ...
        <section className='bg-[#5C95D8] h-28 p-10 section-std'>
